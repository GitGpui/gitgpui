...
use crate::model::{
    ...
    CloneProgressMeter, CloneProgressStage, DiagnosticKind, GitLogSettings, Loadable, RepoId,
    RepoLoadsInFlight, RepoState, SubtreeExtractOpState, SubtreeExtractOpStatus,
